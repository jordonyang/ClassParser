...
public enum BytecodeInstruction {
    ...
    IFNULL(198, "ifnull"),
    IFNONNULL(199, "ifnotnull"),
    GOTO_W(200, "goto_w"),
    JSR_W(201, "jsr_w")
    ;

    BytecodeInstruction(int code, String cmd) {
        this.code = code;
        this.cmd = cmd;
    }
    ...
    public static String getCmd(int code) {
        for (BytecodeInstruction command : values()) {
            if (command.code == code) {
                return command.cmd;
            }
        }
        return "Instruction of " + code + " not found";
    }
}
